...
--[[            	if iteration >= n_elements then
            		...
            		new_pose_flag, new_pose, fs, data  = check_new_poses (n_elements )
            		if new_pose_flag then
            			n_elements = n_elements + 1
            			endframes[new_number] = new_pose 
            			infomsg("  adding new pose point " .. tostring(n_elements)  ) 
            			infomsg("  adding a new pose point " .. tostring(fs)  ) 
