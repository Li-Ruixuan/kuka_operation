...
x_raw = ctx:createInputChannelScalar("f.x")
y_raw = ctx:createInputChannelScalar("f.y")
z_raw = ctx:createInputChannelScalar("f.z")
R_raw = ctx:createInputChannelScalar("f.r")
P_raw = ctx:createInputChannelScalar("f.p")
Y_raw = ctx:createInputChannelScalar("f.yaw")
