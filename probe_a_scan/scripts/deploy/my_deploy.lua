...
sup:getProperty("state_machine"):set(etasl_application_dir.."/scripts/rfsm/my_fsm.lua")
sup:getProperty("additional_code"):set(etasl_application_dir.."/scripts/rfsm/my_fsm_extra.lua")
